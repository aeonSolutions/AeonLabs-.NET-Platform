...
namespace XComponent.SliderBar
{
    ...
    public sealed class DrawMACStyleHelper
    {
        ...
        public static void DrawAquaPill(Graphics g, RectangleF drawRectF, Color drawColor, Orientation orientation)
        {
            ...
            {
                gradientBrush = new LinearGradientBrush(new Point(Conversions.ToInteger(Conversion.Fix(drawRectF.Left)), Conversions.ToInteger(Conversion.Fix(drawRectF.Top - 1))), new Point(Conversions.ToInteger(Conversion.Fix(drawRectF.Left)), Conversions.ToInteger(Conversion.Fix(drawRectF.Top)) + Conversions.ToInteger(Conversion.Fix(drawRectF.Height)) + 1), color1, color5);
            }
            else
            {
                gradientBrush = new LinearGradientBrush(new Point(Conversions.ToInteger(Conversion.Fix(drawRectF.Left - 1)), Conversions.ToInteger(Conversion.Fix(drawRectF.Top))), new Point(Conversions.ToInteger(Conversion.Fix(drawRectF.Left)) + Conversions.ToInteger(Conversion.Fix(drawRectF.Width)) + 1, Conversions.ToInteger(Conversion.Fix(drawRectF.Top))), color1, color5);
            }
            ...
            if (orientation == Orientation.Horizontal)
            {
                gradientBrush = new LinearGradientBrush(new Point(Conversions.ToInteger(Conversion.Fix(drawRectF.Left)) + 1, Conversions.ToInteger(Conversion.Fix(drawRectF.Top))), new Point(Conversions.ToInteger(Conversion.Fix(drawRectF.Left)) + 1, Conversions.ToInteger(Conversion.Fix(drawRectF.Top)) + Conversions.ToInteger(Conversion.Fix(drawRectF.Height - 1))), color2, color5);
            }
            else
            {
                gradientBrush = new LinearGradientBrush(new Point(Conversions.ToInteger(Conversion.Fix(drawRectF.Left)), Conversions.ToInteger(Conversion.Fix(drawRectF.Top)) + 1), new Point(Conversions.ToInteger(Conversion.Fix(drawRectF.Left)) + Conversions.ToInteger(Conversion.Fix(drawRectF.Width - 1)), Conversions.ToInteger(Conversion.Fix(drawRectF.Top)) + 1), color2, color5);
            }
        ...
        public static void DrawAquaPillSingleLayer(Graphics g, RectangleF drawRectF, Color drawColor, Orientation orientation)
        {
            ...
            if (orientation == Orientation.Horizontal)
            {
                gradientBrush = new LinearGradientBrush(new Point(Conversions.ToInteger(Conversion.Fix(drawRectF.Left)), Conversions.ToInteger(Conversion.Fix(drawRectF.Top))), new Point(Conversions.ToInteger(Conversion.Fix(drawRectF.Left)), Conversions.ToInteger(Conversion.Fix(drawRectF.Top)) + Conversions.ToInteger(Conversion.Fix(drawRectF.Height))), color1, color4);
            }
            else
            {
                gradientBrush = new LinearGradientBrush(new Point(Conversions.ToInteger(Conversion.Fix(drawRectF.Left)), Conversions.ToInteger(Conversion.Fix(drawRectF.Top))), new Point(Conversions.ToInteger(Conversion.Fix(drawRectF.Left)) + Conversions.ToInteger(Conversion.Fix(drawRectF.Width)), Conversions.ToInteger(Conversion.Fix(drawRectF.Top))), color1, color4);
            }
